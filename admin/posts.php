...
if (isset($_POST["submit"])) {
  ...
  if (empty($PostTitle)) {
    ...
    global $ConnectingDb;
    $sql = "INSERT INTO news_post(datetime,title,category,admin,image,post,summary)";
    $sql .= "VALUES(:dateTime,:postTitle,:categoryName,:adminName,:imageName,:postDescription,:postSummary)";
