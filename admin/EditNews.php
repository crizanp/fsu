...
if (isset($_POST["submit"])) {
  ...
  if (empty($PostTitle)) {
    ...
    Redirect_to("EditNews.php?id=$SearchQueryParameter");
    ...
    if (!empty($_FILES["Image"]["name"])) {
      $sql = "UPDATE news_post 
      SET title='$PostTitle',category='$Category', image='$Image',post='$PostText',summary='$PostSummary'
      WHERE id='$SearchQueryParameter'";
    } else {
      $sql = "UPDATE news_post 
      SET title='$PostTitle',category='$Category',post='$PostText',summary='$PostSummary'
      WHERE id='$SearchQueryParameter'";
    }
    ...
    if ($Execute) {
      $_SESSION["SuccessMessage"] = "News Post Updated Successfully ";
      Redirect_to("EditNews.php?id=$SearchQueryParameter");
...
<body>
  ...
  <section class="container p-2">
    ...
    echo ErrorMessage();
    global $ConnectingDb;
    $sql = "SELECT * FROM news_post WHERE id=$SearchQueryParameter";
    ...
    ?>
    <div class="">
      <form class="p-2" action="EditNews.php?id=<?php echo $SearchQueryParameter; ?>" method="post"
          ...
          <div class="col-lg">
            ...
            <div class="p-2">
              <div class="form-group">
                ...
                <input value="<?php echo $TitleToBeUpdated; ?>" type="text" class="form-control" name="PostTitle">
              </div>
              <div class="form-group">
                <span>Existing Category:<b>
              ...
              <div class="form-group">
                <span>Existing Image:</span><br><img src="uploads/<?php echo $ImageToBeUpdated; ?>" width="170px"
                  ;height="70px" ;></b></span><br>
                ...
                <div class="form-group">
                  ...
                  <textarea name="editor1" class="form-control" id="postBody"><?php echo $PostToBeUpdated; ?></textarea>
                </div>
                <div class="form-group">
                  <label for="body">
            ...
            while ($DataRows = $stmt->fetch()) {
              ...
              <tbody class="text-center">
                <tr>
                  ...
                  <td><a href="../news-post.php?id=<?php echo $Id; ?>" target="blank"><span class="btn btn-success">See
                        Live</span></a></td>
