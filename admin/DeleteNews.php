...
if (isset($_POST["submit"])) {
  // delete query
  global $ConnectingDb;
  $sql = "DELETE FROM news_post WHERE id ='$SearchQueryParameter'";
  $Execute = $ConnectingDb->query($sql);

  if ($Execute) {
    $Target_Path_To_Delete_Image = "uploads/$ImageToBeUpdated";
    unlink($Target_Path_To_Delete_Image);
    $_SESSION["SuccessMessage"] = "News-Post Deleted Successfully ";
...
<body>
  ...
  <section class="container p-2">
    ...
    <div class="">
      <form class="p-2" action="DeleteNews.php?id=<?php echo $SearchQueryParameter; ?>" method="post"
